...
docker exec -it vmc_admin python3.7 -m vmc loaddata /test_data/demo_data.json
docker exec -it vmc_admin python3.7 -m vmc create_index
...
docker exec -it vmc_admin python3.7 -W ignore /test_data/generate_vulns.py